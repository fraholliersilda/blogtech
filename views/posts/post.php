    ...
    <div class="container">
        ...
        <div class="post-navigation" style="margin-bottom: 20px;">
            ...
            <?php if (
                ...
                <a href="/blogtech/views/posts/edit/<?= $post['id']; ?>" class="btn btn-primary"
                    ...
                    <form method="POST" action="/blogtech/comments/add/<?= $post['id']; ?>">
                        <div class="form-group">
                            <textarea class="form-control comment-textarea" name="content" rows="4"
                                placeholder="Share your thoughts about this post..." maxlength="1000" required></textarea>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <form method="POST" action="/blogtech/posts/delete/<?= $post['id']; ?>"
                        ...
                        <div class="col-md-5 post-card">
                            <div class="post-content">
                                <div class="post-image">
                                    <img src="<?= htmlspecialchars($latestPost['cover_photo_path'] ?? 'default_path.jpg'); ?>"
                                ...
                                <div class="posting-details">
                                    ...
                                    <div class="card-actions" style="margin-bottom: 10px;">
                                        ...
                                        <?php if (
                                            ...
                                            <a href="/blogtech/views/posts/edit/<?= $latestPost['id']; ?>"
                                                class="btn btn-primary btn-sm" style="margin-left: 5px;">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#deleteModal<?= $latestPost['id']; ?>" style="margin-left: 5px;">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    "<strong><?= htmlspecialchars($latestPost['title']); ?></strong>"?
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-default"
                                                        data-dismiss="modal">Cancel</button>
                                                    <form method="POST" action="/blogtech/posts/delete/<?= $latestPost['id']; ?>"
                                                        style="display: inline;">
                                                        <button type="submit" class="btn btn-danger">Delete</button>
                                                    </form>
                                                </div>
